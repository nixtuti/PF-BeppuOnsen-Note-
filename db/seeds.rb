...
HotSpring.create!([
    ...
    {name: "亀陽泉", hot_spring_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/kiyousen.jpg"), filename:"kiyousen.jpg"), introduction: "2016年に改装した市営温泉。熱湯とぬる湯があります。", address: "別府市亀川中央町10-26", price: "大人250円　小人100円", private_bath_price: "-", hours: "6:30〜13:00　14:00～22:30", holiday: "第1水曜日（祝日の場合翌日）", parking: "3台", contact: "電話：0977-66-2666", is_pablished: 1, running_status: 0, quality_ids: 1, tag_ids:[10,11,12,15,18] },
    {name: "みかゑり温泉", hot_spring_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/mikaeri.jpg"), filename:"mikaeri.jpg"), introduction: "金気香る食塩泉。温泉に入った人は地獄釜を無料で使用できます（食材持参または購入、肉と魚以外）。", address: "別府市火売8組2", price: "300円", private_bath_price: "1000円", hours: "10:00〜受付21:00", holiday: "なし", parking: "20台", contact: "電話：0977-66-1186", is_pablished: 1, running_status: 0, quality_ids: 2, tag_ids:[2,3,6,12,15] },
    {name: "わくわく温泉かっぱの湯", hot_spring_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/kaxtupa.jpg"), filename:"kaxtupa.jpg"), introduction: "スーパー銭湯のような温泉。ジェットバスなどの湯船を楽しめます。", address: "別府市汐見町3番17号", price: "440円", private_bath_price: "-", hours: "12:00～翌朝9：00、土・日曜、祝日24時間", holiday: "不定（毎月１回）", parking: "80台", contact: "電話：0977-21-0600", is_pablished: 1, running_status: 0, quality_ids: 2, tag_ids:[3,5,10,11,12,15,18] },
    {name: "スーパー温泉やまなみの湯", introduction: "スーパー銭湯の温泉バージョン。リニューアルし、セルフロウリュを導入するなど、サウナ設備を拡大、外気浴スペースも確保されています。", address: "別府市北中7-2　ダイちゃんランド内", price: "480円", private_bath_price: "60分　2000円～", hours: "12：00 ~ 翌8 : 40（月2回月曜日は15:00より開店）土日、祝日は24時間営業", holiday: "なし", parking: "700台", contact: "電話：0977-67-4126", is_pablished: 1, running_status: 0, quality_ids: 1, tag_ids:[2,3,5,10,11,12,15,18] },
    {name: "おかたの湯", introduction: "家族湯専門の温泉施設です。ケイ酸分が多く美肌効果があります。2室源泉掛流し、その他の部屋コイン入替え式", address: "別府市竹の内5組", price: "貸切湯のみ", private_bath_price: "貸切湯1500円～", hours: "11:00〜受付22:00、土・日曜・祝日9:00〜受付22:00", holiday: "不定休", parking: "20台", contact: "電話：0977-22-4126", is_pablished: 1, running_status: 0, quality_ids: 1, tag_ids:[2,3,10,11,13,15,17,18] },
    {name: "ひょうたん温泉", introduction: "世界で初めて、竹製温泉冷却装置を設置。ミシュランガイドにも掲載されており、観光観光客が多く訪れます。改装され、設備も充実、綺麗で雰囲気のある温泉です。", address: "別府市鉄輪159-2", price: "21:00まで　13歳以上 860円 7～12歳 380円 4～6歳 260円 3歳以下 無料　※21:00以降値下げあり", private_bath_price: "基本料金１時間（大人3名様まで） 2300円", hours: "9:00〜深夜1:00", holiday: "年２～３回臨時休業", parking: "80台", contact: "電話：0977-66-0527", is_pablished: 1, running_status: 0, quality_ids: 2, tag_ids:[2,3,5,6,7,10,11,12,13,15,18] }
    ])
